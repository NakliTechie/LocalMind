...
- **[Ternary Bonsai 2 27B](https://huggingface.co/prism-ml/Ternary-Bonsai-2-27B-gguf)** — ternary (PTQ1_0, 1.75 bits/weight) Qwen3.8-27B, custom WebGPU kernels engine (`ternary_bonsai_2_27b.js`), ~5.9 GB, Apache-2.0 weights
